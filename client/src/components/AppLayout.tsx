          ...
          <div className="flex md:hidden items-center justify-between w-full h-full relative">
            <div className="flex items-center space-x-2">
              {(!sidebarOpen) && (
                <button 
                  ...
                  className="w-11 h-11 flex items-center justify-center rounded-lg hover:bg-slate-900 border border-transparent hover:border-slate-850 text-slate-455 hover:text-white cursor-pointer shrink-0"
            ...
            <div className="flex items-center space-x-2">
              ...
              <button 
                ...
                className="w-11 h-11 flex items-center justify-center rounded-full bg-slate-900 border border-slate-850 hover:bg-slate-850 text-slate-405 hover:text-white relative cursor-pointer"
              ...
              <button 
                onClick={toggleTheme}
                className="w-11 h-11 flex items-center justify-center rounded-full bg-slate-900 border border-slate-850 hover:bg-slate-850 text-slate-405 hover:text-white cursor-pointer transition-all"
          ...
          <div className="hidden md:flex md:flex-col md:space-y-4.5 w-full relative">
            ...
            <div className="flex items-center space-x-3 w-full">
              {(!sidebarOpen) && (
                <button 
                  onClick={() => setSidebarOpen(true)}
                  className="p-1.5 rounded-lg hover:bg-slate-900 border border-transparent hover:border-slate-850 text-slate-450 hover:text-white cursor-pointer shrink-0"
