        ...
        {(['roster', 'analytics', 'cms'] as const).map((tab) => (
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
              adminActiveTab === tab ? 'bg-lc-violet text-lc-text shadow' : 'text-lc-text-muted hover:text-lc-text'
            }`}
          >
                  ...
                  >
                    ...
                    <td>
                      <span className={`font-mono font-bold ${
                        s.readinessScore >= 75 ? 'text-lc-emerald' : 'text-lc-amber'
            ...
            <div className="flex space-x-1 bg-lc-void/40 p-1 rounded-lg border border-lc-glass-border">
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-[9px] font-bold uppercase transition-all cursor-pointer ${
                  cmsTab === 'coding' ? 'bg-lc-violet text-lc-text shadow' : 'text-lc-text-muted hover:text-lc-text'
                }`}
              >
                Coding CMS
              </button>
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-[9px] font-bold uppercase transition-all cursor-pointer ${
                  cmsTab === 'mcq' ? 'bg-lc-violet text-lc-text shadow' : 'text-lc-text-muted hover:text-lc-text-muted'
                }`}
              >
                MCQ Questions CMS
              </button>
                    ...
                    <div key={p.id} className="flex justify-between items-center py-2.5 text-[10px]">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className={`px-1.5 py-0.5 rounded text-[8px] font-bold ${
                          p.difficulty === 'EASY' ? 'bg-lc-emerald/10 text-lc-emerald' : 'bg-lc-amber/10 text-lc-amber'
                        }`}>
                          {p.difficulty}
                        </span>
                        <button
              ...
              {(['stats', 'insights', 'logs'] as const).map((mtab) => (
                <button
                  ...
                  className={`flex-1 py-1.5 rounded text-[9px] font-bold uppercase transition-all cursor-pointer ${
                    modalTab === mtab ? 'bg-lc-cyan text-lc-void' : 'text-lc-text-muted hover:text-lc-text'
                  }`}
                >
              ...
              <div className="space-y-4 text-left">
                <div className="p-4 rounded-xl bg-lc-violet/5 border border-lc-violet/20 flex justify-between items-center">
                  ...
                  <span className={`px-2.5 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider ${
                    selectedStudent.readinessScore >= 80 ? 'bg-lc-emerald/10 text-lc-emerald border border-lc-emerald/20' : 'bg-lc-amber/10 text-lc-amber border border-lc-amber/20'
                  }`}>
